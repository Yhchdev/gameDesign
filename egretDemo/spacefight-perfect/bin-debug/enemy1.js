...
var enemy1 = (function (_super) {
    ...
    enemy1.prototype.box_build = function () {
        var data = RES.getRes("mc1_json"); //获取mc1帧动画的配置
        var txtr = RES.getRes("mc1_png"); //获取mc1帧动画的png图片
        var mcFactory = new egret.MovieClipDataFactory(data, txtr); //创建帧动画对象
        this.mc = new egret.MovieClip(mcFactory.generateMovieClipData("enemy1")); //载入帧动画    
