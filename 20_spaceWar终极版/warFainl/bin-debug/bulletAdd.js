...
var bulletAdd = (function (_super) {
    __extends(bulletAdd, _super);
    //我的位置 touch_x ,touch_y
    function bulletAdd(touch_x, touch_y) {
    ...
    //构建子弹
    bulletAdd.prototype.bullet_build = function () {
        this.bullet = new egret.Bitmap;
        this.bullet.texture = RES.getRes("bbuff_png");
        this.bullet.scaleX = 0.4;
        this.bullet.scaleY = 0.4;
        this.addChild(this.bullet);
        this.addEventListener(egret.Event.ENTER_FRAME, this.box_move, this); //增加enter_frame监听，让自己每一帧都能调用函数，实现向下移动
    };
    bulletAdd.prototype.box_move = function () {
        if (this.hit == false) {
    ...
    bulletAdd.prototype.initial = function (touch_x, touch_y) {
        //重用的子弹初始化  操作
        this.hit = false;
        this.recycle = false;
        this.x = touch_x;
...
__reflect(bulletAdd.prototype, "bulletAdd");
//# sourceMappingURL=bulletAdd.js.map